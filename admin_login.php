...
<button type="submit" class="btn btn-primary form-control" name="adminLogin">Login</button>
...
if(isset($_POST['adminLogin']))
{
	...
	$matchDetails = mysqli_query($config,"SELECT * from admin_registration WHERE admin_email ='$adminEmail' AND admin_password='$adminPassword'");

	if(mysqli_num_rows($matchDetails) > 0)
	{
		session_start();
		$_SESSION['loggedinAdmin'] = $adminEmail;
